                ...
                <section className="px-4 py-5">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            onClick={() =>
                                alert(
                                    "This would show all onboarding tasks in a detailed view."
                                )
                            }
                        >
                            View All
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center mt-1">
                                        ...
                                        <p className="ml-1 text-sm opacity-90">
                                            points
                                        </p>
                                    </div>
                ...
                <section className="px-4 py-3">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            onClick={() =>
                                alert(
                                    "This would show your complete portfolio with all services and activities."
                                )
                            }
                        >
                            View All
