import { CreditCard, Building, Car, Lightbulb, DollarSign, MapPin, Calendar } from "lucide-react"
...
export const mockInsights = [
  {
    ...
    description: "Based on your timeline, prioritize banking setup within your first week",
  ...
  },
  {
    ...
    description: "Your initial 3-month spending forecast based on profile",
  ...
  },
  {
    ...
    description: "Rental prices in Dubai Marina are stabilizing",
  ...
  },
  {
    ...
    description: "Based on your work location, these areas minimize commute",
  ...
  },
  {
    ...
    description: "SUVs offer best value for families in UAE",
  ...
  },
  {
    ...
    description: "For your 3-year stay, leasing offers better flexibility",
    icon: <Car className="h-5 w-5 text-purple-600" />,
    trend: "neutral",
  ...
  },
  {
    ...
    description: "Optimal timing for setting up utilities and services",
  ...
  },
  {
    ...
    description: "Outdoor activities best enjoyed during winter months",
